# Functions from file
source("H:/Academic/Bioinformatics/tools/R_scripts/GSEA/Trinotate_GSEA_plotteR/Trinotate_GSEA_plotteR.R")
...
#plotGSEA(geneset_results, cont = contrasts[2], GSEA_filter = "pvalue<=0.01", groupOntology = 1, bar_cols = bar_color_names, bar_width = 0.45, savePlot = TRUE, saveFormat = "pdf", rotateSavedPlot = FALSE, prettyTermOpts = "charNum=35, comma=FALSE", plot_width = 15, plot_height = 15)

# plot all contrasts (vertical, no facets).
sapply(levels(geneset_results$contrast), function(x) plotGSEA(geneset_results, cont = x, bar_cols = bar_color_names, bar_width = 0.45, GSEA_filter = "pvalue<=0.01", savePlot = TRUE, prettyTermOpts = "charNum=35, comma=FALSE", plot_width = 15, plot_height = 15))
...
# Plot just 1 contrast:
#plotGSEA(geneset_results, cont = contrasts[1], groupOntology = 1, ont_cols = ko_ont_cols, GSEA_filter = "pvalue<=0.05", bar_cols = bar_color_names, bar_width = 0.45, prettyTermOpts = "comma=FALSE, charNum=45", savePlot = FALSE, saveFormat = "pdf", rotateSavedPlot = FALSE, plot_width = 15, plot_height = 15)
